  ...
  USERS: [
    {
      ...
      id: "oSt5X6_u-syyjClS4sC63eDOOrgY",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "C78Z0qPqABleLWpleBl1wPwPxoJg8WHjCEuAmEDzJrw",
      // 所在省份
      province: "北京",
      // 所在城市
      city: "北京",
      ...
      openUrl: "https://pan.hykhd.com",
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "*生日", "name": "宝贝", "year": "1997", "date": "04-08"}
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2015-01-13"}
      ]
    }
    // 你可以不断按格式往下增加
    // ...
